...
@section('content')
    ...
    {{-- ✅ FIX: modal input polygon — hapus duplikat id preview-image-polygon --}}
                ...
                <form id="form-edit" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description_polygon" name="description" placeholder="Add description" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
...
@section('scripts')
    ...
    `;
        ...
        function editData(id, name, description, image, geometry) {
            ...
            $('#name_polygon').val(name);

            $('#description_polygon').val(description);

            // convert coordinates ke POLYGON
            var coords = geometry[0].map(function(coord) {
